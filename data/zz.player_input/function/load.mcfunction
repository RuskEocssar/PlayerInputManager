...
## 入力の初期設定
    execute unless data storage player_input: click_item run data modify storage player_input: click_item set value {input_interval:2,hold_threshold:6,double_input_range:{min:2,max:3}}
    execute unless data storage player_input: key_input run data modify storage player_input: key_input set value {input_interval:2,hold_threshold:6,double_input_range:{min:2,max:3}}
