...
## アイテム管理用のエンティティ
    execute unless score 4fe002bb-0000-0002-0000-000a00000001 _ matches 1 store success score 4fe002bb-0000-0002-0000-000a00000001 _ run summon interaction 0 1000 0 {UUID:[I;1340080827,2,10,1],width:0f,height:0f}
