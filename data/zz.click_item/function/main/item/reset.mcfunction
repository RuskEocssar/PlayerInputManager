...
## アイテムのNBTをセット
    ...
    execute if data storage click_item: item.components."minecraft:custom_data"{_slot:"mainhand"} run item replace entity @p[tag=_player] weapon.mainhand from entity @s container.0
