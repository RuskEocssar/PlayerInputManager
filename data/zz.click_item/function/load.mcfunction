...
## 入力の初期設定
    execute unless data storage click_item: click_interval run data modify storage click_item: click_interval set value {min:1,max:4}
    execute unless data storage click_item: double_click_interval run data modify storage click_item: double_click_interval set value {min:2,max:5}
