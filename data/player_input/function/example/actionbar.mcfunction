...
data modify storage debug: list append from storage player_input: history[{action_type:"tap"}]
...
title @a subtitle [{text:" > ",color:"gray"},{nbt:"list[-5].key",storage:"debug:",interpret:true,color:"gold"},{text:" > ",color:"gray"},{nbt:"list[-4].key",storage:"debug:",interpret:true,color:"gold"},{text:" > ",color:"gray"},{nbt:"list[-3].key",storage:"debug:",interpret:true,color:"gold"},{text:" > ",color:"gray"},{nbt:"list[-2].key",storage:"debug:",interpret:true,color:"gold"},{text:" > ",color:"gray"},{nbt:"list[-1].key",storage:"debug:",interpret:true,color:"gold"}]
title @a title ""